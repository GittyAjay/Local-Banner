...
import { Animated, View, Text, StyleSheet, Button, Pressable, ScrollView, Platform, StatusBar } from 'react-native'
                ...
                <View style={{ flex: 1, flexDirection: 'column', justifyContent: 'space-between' }}>
                    ...
                    <View style={{ flexDirection: 'column' }}>
                        ...
                        <View style={[styles.buttomCorner_input_box, {
                            borderColor: Colors.GREY, paddingLeft: DEFAUTL_SPACE,
                            paddingBottom: DEFAUTL_SPACE / 2,
                            paddingTop: DEFAUTL_SPACE / 2,
                            borderWidth: BORDER_WIDTH,
                            ...
                            <TextInput onChange={text => changeUsername} value={username} style={{ fontSize: FONT_MID, fontFamily: 'Comfortaa-Bold' }} placeholder="Phone number" keyboardType="phone-pad" />
                        </View>
                        <View>
                    ...
                    <View style={styles.button_container}>
                        <Pressable style={({ pressed }) => [
                            { transform: [{ scale: pressed ? 0.94 : 1 },], borderRadius: BORDER_RADIUS, padding: DEFAUTL_SPACE + 3, }, styles.button
                        ]}>
                            <Text style={{ color: 'white', fontFamily: 'Comfortaa-Bold', fontSize: FONT_MID }}>Continue</Text>
                        </Pressable>
                    </View>
...
behavior="position" keyboardVerticalOffset={-550}>   */}
                <View style={[styles.social_buttons]}>
                    <View style={styles.button_container}>
                        <Pressable style={({ pressed }) => [
                            { transform: [{ scale: pressed ? 0.94 : 1 },], backgroundColor: pressed ? Colors.IVORY : Colors.WHITE, borderRadius: BORDER_RADIUS, padding: DEFAUTL_SPACE + 3, }, styles.border_button
                        ]}>
                    ...
                    <View style={styles.button_container}>
                        <Pressable style={({ pressed }) => [
                            ...
                            <FAIcon name="google" color="black" size={ICON_SIZE} style={{ flexGrow: 1 }} />
                            <Text style={{ color: Colors.BLACK, fontFamily: 'Comfortaa-Bold', fontSize: FONT_MID, flexGrow: 1.5 }}>Continue with Facebook</Text>
                        </Pressable>
                    </View>
                    <View style={styles.button_container}>
